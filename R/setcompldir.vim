...
elseif has("win32") && $APPDATA != "" && isdirectory($APPDATA)
    g:rplugin.compldir = $APPDATA .. "\\vim-rr"
elseif $XDG_CACHE_HOME != "" && isdirectory($XDG_CACHE_HOME)
    g:rplugin.compldir = $XDG_CACHE_HOME .. "/vim-rr"
elseif isdirectory(expand("~/.cache"))
    g:rplugin.compldir = expand("~/.cache/vim-rr")
elseif isdirectory(expand("~/Library/Caches"))
    g:rplugin.compldir = expand("~/Library/Caches/vim-rr")
else
...
if need_readme
    ...
    writefile([first_line,
        '',
        'The files in this directory were generated by vim-rr automatically:',
